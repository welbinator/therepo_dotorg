...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (categoriesInput) {
    ...
    function fetchSuggestions(query) {
      ...
      fetch(`/wp-json/wp/v2/plugin-category?search=${encodeURIComponent(query)}`).then(response => response.json()).then(data => {
  ...
  if (searchField && typeFilter && categoryFilter && grid) {
    function updateGrid() {
      ...
      xhr.open('GET', `/wp-admin/admin-ajax.php?action=filter_plugins&search=${encodeURIComponent(search)}&type=${encodeURIComponent(type)}&category=${encodeURIComponent(category)}`, true);
      xhr.onload = function () {
        if (xhr.status === 200) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_repo_categories_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/repo-categories.js */ "./src/js/repo-categories.js");
